...
FONT_SIZE = 100
#FONT_FILE_PATH = "resources/src/fonts/RalewayThin.otf"
FONT_FILE_PATH = "resources/src/fonts/NexaLight.otf"

OUTPUT_IMAGE_FILEPATH_TEMPLATE_WHITE = "resources/src/images/num_white_%d.png"
OUTPUT_IMAGE_FILEPATH_TEMPLATE_BLACK = "resources/src/images/num_black_%d.png"
...
if __name__ == "__main__":
    ...
    for digit in range(0, 10):
        ...
        tile_image.save(OUTPUT_IMAGE_FILEPATH_TEMPLATE_WHITE % digit)

        meta_data_entries.append(META_DATA_TEMPLATE % (digit, digit))

	r, g, b = tile_image.split()
	...
	def invert(image):
        ...
        img2 = Image.merge(tile_image.mode, (r, g, b))

        img2.save(OUTPUT_IMAGE_FILEPATH_TEMPLATE_BLACK % digit)
